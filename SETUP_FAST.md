...
3. 以下の情報を入力：
   - **名前**: `gemini-api-key`
   - **シークレットの値**: `AIzaSyC39YRwttNDsVj6ZSWLhq8ljbiGyW9YcZo`
   - **リージョン**: `自動`
...
# 3. Secret Manager（数秒）
echo "AIzaSyC39YRwttNDsVj6ZSWLhq8ljbiGyW9YcZo" | gcloud secrets create gemini-api-key --data-file=- --replication-policy="automatic" --project=singular-server-480006-s8
